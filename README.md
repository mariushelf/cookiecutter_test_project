...
[![Tests](https://github.com/joesgithub/cookiecutter_test_project/actions/workflows/cicd.yaml/badge.svg)](https://github.com/joesgithub/cookiecutter_test_project/actions/workflows/cicd.yaml)
[![codecov](https://codecov.io/gh/joesgithub/cookiecutter_test_project/branch/master/graph/badge.svg)](https://codecov.io/gh/joesgithub/cookiecutter_test_project)
[![PyPI version](https://badge.fury.io/py/cookiecutter_test_project.svg)](https://pypi.org/project/cookiecutter_test_project/)
[![Documentation Status](https://readthedocs.org/projects/cookiecutter_test_project/badge/?version=latest)](https://cookiecutter_test_project.readthedocs.io/en/latest/?badge=latest)


Python Boilerplate contains all the boilerplate you need to create a Python package.

Original repository: [https://github.com/joesgithub/cookiecutter_test_project](https://github.com/joesgithub/cookiecutter_test_project)
...
3. In the [Github repository settings](https://github.com/joesgithub/cookiecutter_test_project/settings/environments),
   create a new environment named `production`. If you are the only
   contributor, you can leave all settings at the default.
4. Under [Secrets -> actions](https://github.com/joesgithub/cookiecutter_test_project/settings/secrets/actions),
...
3. create a matching tag on your local machine and push it to the
   ...
   git push --tags
   ```
4. In [Github actions](https://github.com/joesgithub/cookiecutter_test_project/actions)
   make sure that the test workflow succeeds.
5. In the Github [release tab](https://github.com/joesgithub/cookiecutter_test_project/releases)
   ...
   [PyPI](https://pypi.org/project/cookiecutter_test_project/).
...
`pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ cookiecutter_test_project`
...
Joe Doe 
  ([joe@example.com](mailto:joe@example.com))
